...
public class Utility extends ManageBrowser {
    ...
    //method to send text on element
    ...
    // method to return all List of Elements

    public List<WebElement> findElements(By by) {
        return driver.findElements(by);
    }

   //Method to verify the actual and expected elements
    ...
    //method to send text from alert

    public void sendTextToAlert(String text) {
        driver.switchTo().alert().sendKeys(text);
    }

   // method to select the option by visible text
